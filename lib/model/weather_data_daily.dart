class WeatherDataDaily {
  ...
  factory WeatherDataDaily.fromJson(Map<String, dynamic>? json) {
    if (json == null || json['daily'] == null) {
      // Handle the case where json or 'daily' key is null
      return WeatherDataDaily(daily: []);
    }

    var dailyList = json['daily'];
    return WeatherDataDaily(
      daily: List<Daily>.from(dailyList.map((e) => Daily.fromJson(e))),
    );
  }
}

// class WeatherDataDaily {
//   final List<Daily>? daily; // Allow current to be null
